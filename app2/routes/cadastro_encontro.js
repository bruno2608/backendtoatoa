...
//
const cadastro_encontroController = require("../controllers/encontroController"); //importando os comportamentos do nosso controlador de pessoas
const cadastro_encontroMid = require("../middlewares/encontroMiddleware"); //importando os comportamentos do nosso middleware
...
router.post("/",  cadastro_encontroMid.teste, cadastro_encontroController.saveEncontro);
